...
Page({
  data: {
    ...
    // 🎛️ 线上动态功能开关配置
    features: { ai_plan: false, diet_diagnosis: true, photo_recognize: true, poster_share: true, team_challenge: true, water_log: true, week_dashboard: true, month_dashboard: true, user_feedback: true, pet_system: true },
    contactConfig: null,
