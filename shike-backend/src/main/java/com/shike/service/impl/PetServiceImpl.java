...
public class PetServiceImpl implements PetService {
    ...
    public PetInteractVO interactWithAi(Long userId, PetInteractDTO dto) {
        ...
        return switch (petType.toUpperCase()) {
            case "DRAGON" -> "傲娇奶萌的小青龙木木，嘴硬心软的减脂督导闺蜜，关注主人的燃脂和体态，口癖是‘嗷呜～’、‘哼哼’、‘今天也要美美变强！’。";
            case "TOTORO" -> "温吞治愈的毛绒大龙猫呼噜，充满松弛感与包容心，最关心主人吃得健不健康、水喝得够不够，口癖是‘呼噜噜～’、‘慢慢来，宝宝超棒的’。";
            case "CAT"    -> "灵动撒娇的元气小橘猫，最懂女孩子的身材焦虑与体态美，无条件支持主人，口癖是‘喵呜～’、‘今天也超级美喵～’。";
            case "DOG"    -> "阳光忠诚的柴犬旺财，精力充沛的小太阳，随时准备陪主人慢跑散步、甩掉疲惫，口癖是‘汪汪！’、‘主人天下第一棒！’。";
